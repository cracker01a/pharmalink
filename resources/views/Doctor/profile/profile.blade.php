...
<!-- 
                                        ...
                                        <div class="profile-personal-info">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-9"><span>{{ $user->firstname }} {{ $user->lastname }}</span></div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-3">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-9"><span>{{ $doctor->hopital ?? 'Not specified' }}</span></div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-3">
                                                    <h5 class="f-w-500">Year Experience <span class="pull-right">:</span></h5>
                                                </div>
                                                <div class="col-9"><span>{{ $doctor->annee_experience ?? 'Not specified' }} Year Experiences</span></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="settings-form">
                                            ...
                                            <form method="POST" action="{{ route('doctor.update') }}" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label>Hôpital</label>
                                                        <input type="text" name="hopital" value="{{ $doctor->hopital ?? '' }}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Spécialité</label>
                                                    <input type="text" name="specialite" value="{{ $doctor->specialite ?? '' }}" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label>Adresse</label>
                                                    <input type="text" name="adresse" value="{{ $doctor->adresse ?? '' }}" class="form-control">
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label>Âge</label>
                                                        <input type="number" name="age" value="{{ $doctor->age ?? '' }}" class="form-control">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label>Années d'expérience</label>
                                                        <input type="number" name="annee_experience" value="{{ $doctor->annee_experience ?? '' }}" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Compétences</label>
                                                    <textarea name="competences" class="form-control">{{ $doctor->competences ?? '' }}</textarea>
                                                </div>
                                                <div class="form-group">
