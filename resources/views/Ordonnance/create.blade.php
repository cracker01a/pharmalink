									...
									<div class="tab-content">
											...
											<div class="row">
												<div class="col-lg-6 mb-2">
													<div class="form-group">
														<label class="form-label">prenom du patient<span class="required">*</span></label>
                                                ...
                                                <div class="col-lg-6 mb-2">
													<div class="form-group">
														...
														<input type="birthdate" name="birthdate" class="form-control" placeholder="Parsley" required>
													</div>
												</div>
												<div class="col-lg-6 mb-2">
													<div class="form-group">
										...
										<div id="wizard_Time" class="tab-pane" role="tabpanel">
											<div class="row">
												...
												<div class="col-lg-6 mb-2">
													<div class="form-group">
														<label class="form-label">Company Email Address<span class="required">*</span></label>
														<input type="email" class="form-control" id="emial1" placeholder="example@example.com.com" required>
													</div>
												</div>
												<div class="col-lg-6 mb-2">
													<div class="form-group">
														<label class="form-label">Company Phone Number<span class="required">*</span></label>
														<input type="text" name="phoneNumber" class="form-control" placeholder="(+1)408-657-9007" required>
													</div>
												</div>
												<div class="col-lg-6 mb-2">
													<div class="form-group">
														<label class="form-label">Your position in Company<span class="required">*</span></label>
														<input type="text" name="place" class="form-control" required>
													</div>
												</div>
											</div>
