                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" id="firstname" value="{{ old('firstname', $user->firstname)}}" placehloder=" Ex : Jean">
                                                @error('firstname')
