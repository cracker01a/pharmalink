                    ...
                    <div class="card-body">
                        ...
                        <div class="profile-news">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="images/profile/5.jpg" alt="image" class="me-3" width="75">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="images/profile/6.jpg" alt="image" class="me-3" width="75">
                                <div class="media-body">
                                    <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                    <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                </div>
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="images/profile/7.jpg" alt="image" class="me-3" width="75">
                                <div class="media-body">
                                    <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                    <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="about-me" class="tab-pane fade">
                                        ...
                                        <div class="profile-lang  mb-5">
                                            ...
                                            <a href="javascript:void()" class="text-muted ps-3 f-s-16"><i class="flag-icon flag-icon-us"></i> English</a> 
                                            <a href="javascript:void()" class="text-muted ps-3 f-s-16"><i class="flag-icon flag-icon-fr"></i> French</a>
                                            <a href="javascript:void()" class="text-muted ps-3 f-s-16"><i class="flag-icon flag-icon-bd"></i> Bangla</a>
                                        </div>
